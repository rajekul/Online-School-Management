            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa  fa-check  fa-fw"></i> Access Type:<?php echo $this->session->userdata("usertype"); ?> <br/><i class="fa fa-user fa-fw"></i> Admin <i class="fa fa-caret-down"></i>
                    </a>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
									<a href="#">Daily Attendance <span class="fa arrow"></span></a>
									<ul class="nav nav-third-level">
										...
										<?php 
											...
											foreach($classes as $class){
												echo '
													<li>
														<a href="'.base_url().'Attendance/dailyattendance/'.$class['classid'].'"><i class="fa fa-angle-right  fa-fw"></i> Class '.$class['classname'].' </a>
													</li>
												';
											}
										?>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
									<a href="#">Add Exam Marks <span class="fa arrow"></span></a>
									<ul class="nav nav-third-level">
										...
										<?php 
											...
											foreach($classes as $class){
												echo '
													<li>
														<a href="'.base_url().'Exam/managemarks/'.$class['classid'].'"><i class="fa fa-angle-right  fa-fw"></i> Class '.$class['classname'].' </a>
													</li>
												';
											}
										?>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-usd fa-fw"></i> Accounting<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                               <li>
                                    <a href="<?php echo base_url(); ?>Accounting/fees">Manage Fees</a>
                                </li>
							   <li>
                                    <a href="#">Student Payment<span class="fa arrow"></span></a>
                                    <ul class="nav nav-third-level">
                                        
                                        <li>
                                            <a href="<?php echo base_url(); ?>Accounting/addpayments">Create Payment</a>
                                        </li>
										<li>
                                            <a href="<?php echo base_url(); ?>Accounting/payments">Payments</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-third-level -->
                                </li>
								<li>
                                    <a href="<?php echo base_url(); ?>Accounting/expenses">Expense</a>
