	...
	<head>
		...
		?>
			...
			<div class="row">
					...
					<div class="col-sm-2 " >
						<a href="<?php echo base_url(); ?>Student/addstudent" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-plus-sign"></span> Admit Student</a>
					</div>
						...
						<table class="table table-bordered" style="border:1px solid lightgray">
							...
							{students}
								<tr>
									...
									<a href="<?php echo base_url(); ?>Student/editstudent/{sid}">Edit</a> | 
									<a class="text-danger" href="<?php echo base_url(); ?>Student/deletestudent/{sid}}">Delete</a></td>
								</tr>
							{/students}
							</tbody>
						</table>
