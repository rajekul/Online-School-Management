						...
						<?php 
							foreach($students as $student){
								...
								echo '<tr>
										...
										<td><input type="radio" name="'.$student['sid'].'" value="P" '.$present.'/> Present &nbsp <input type="radio" name="'.$student['sid'].'" value="A" '.$absent.'/> Absent
										<input type="hidden" name="s'.$student['sid'].'" value="'.$student['serial'].'"/> </td>
									</tr>';
							}
